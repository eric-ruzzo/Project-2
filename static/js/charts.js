...
var local_ticker = localStorage.getItem("ticker");
console.log('local ticker', local_ticker);
var today = new Date();
...
function init() {
    ...
    console.log(date);
        ...
        // current ticker info passed in from charts.html

      ticker = d3.select("#ticker-id").text
